...
def plot_umap_clusters(df: pd.DataFrame):
    ...
    plt.title("NLP Astroturfing Narratives (UMAP Projection colored by HDBSCAN Cluster)", fontsize=14)
...
def plot_cluster_breakdown(df: pd.DataFrame):
    ...
    plt.title("Average Author Trust Score Built per Narrative Cluster", fontsize=14)
